...
import {uniq, find, matchesProperty} from 'lodash';
...
const relateTo = ({
  ...
  const relations = Class.getBehavior('relations');
  // console.log(relations, relations[0], relations[0].Behavior, foreignClassName, find(relations, matchesProperty('Behavior.options.foreignClass', foreignClassName)));
  relations.map((relation) => {
    console.log(relation, relation.Behavior, relation.options);
  })
