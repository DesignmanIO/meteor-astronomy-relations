...
const relateTo = ({
  ...
  console.log(relations, relations[0].Behavior, relations[0].Behavior.options, foreignClassName, find(relations, matchesProperty('Behavior.options.foreignClass', foreignClassName)));
